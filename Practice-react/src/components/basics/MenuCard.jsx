        ...
        <>
            <section className='main-card--cointainer'>
                {menuData.map((curElem) => {
                    const { idx, name, category, image, description } = curElem
                    return (
                        <>
                            <div className='card-container key={curElem.idx}'>
                                <div className='card'>
                                    <div className='card-body'>
                                        <span className='card-number card-circle subtle'>{curElem.idx}</span>
